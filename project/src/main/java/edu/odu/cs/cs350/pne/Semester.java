...
public class Semester {
    ...
    public boolean supplyDirectories(String pastDirectory, String currentDirectory) {
     ...
     * each semester directory will contain a file named dates.txt with two specific
     * dates:
     * one for first day of pre-reg and one for after the add deadline.
     * this function will ignore any dates BEFORE the pre-reg date and any AFTER the
     * add deadline.
     */
    ...
    public void supplyCutoff(String args[]) throws Exception {
        ...
        // read the first line of dates.txt as preReg date and second line as
        // addDeadline date
        ...
        // look at all .csv files and then ignore dates outside of prereg and
        // addDeadline
